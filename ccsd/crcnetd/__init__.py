...
#
# Basic Initialisation and daemonisation services that are likely to be used
# by program or script that integrates with the configuration system.
#
...
# This file is a place holder to create the crcnetd package!
