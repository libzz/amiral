 ...
 *
 * Ethernet Client Web Interface for the CRCnet Configuration System
 *
...
// Register Rules
var myrules = {
    '#ethernet_customer_link' : function(element){
        element.onchange = propertyChanged;
    },
    '#ethernet_customer_firewall' : function(element){
        element.onchange = propertyChanged;
    }
};
...
function propertyChanged(e)
{
    ...
    // Update
    pars =  "do=updateEthernetCustomerProperty&service_id=" + service_id + 
        "&propName=" + name + "&value=" + val;
    myAjax = new Ajax.Updater(
        {success: 'ethernet_customer-details'}, url, 
