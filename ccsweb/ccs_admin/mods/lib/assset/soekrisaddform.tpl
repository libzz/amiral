...
{include file="header.tpl" title="Asset Management - Add Soekris Asset"}

<form method="post" action="asset.php" onsubmit="return validateForm();">
<input type="hidden" name="do" value="addsoekris">
...
<br>
<h2>Invididual Soekris Details</h2>
<table>
<tr>    
    <th width="200">No. Soekris to add:</th>
    <td>
    <input type="text" id="no_soekris" name="no_soekris" value="1" size=32 class="assetdetails" /> 
    </td>
</tr>
</table>
<br />
Enter the details for your soekris below, you only need to specify one of
<i>Serial No.</i> or <i>eth0 Mac</i>.<br />
<table id="isoekris-table">
<tr>
    <th>Soekris No.</th>
    <th>Serial No.</th>
    <th>eth0 Mac</th>
...
<input type="submit" name="submit" id="submit" value="Add Soekris Assets &gt;&gt;" disabled>
</form>
<ul>
<br>
