...
<input type="hidden" name="do" value="newclass"/>
...
<tr>
    ...
    <td><input type="checkbox" name="ipfromoid" id="ipfromoid" value="yes" />Useful on classes doing a walk of a table where the ip is added after the supplied oid, this data is used to match an interface to a link.</td>
</tr>
<tr>
    <th>Skip software interfaces</th>
    <td><input type="checkbox" name="skip_software_loop" id="skip_software_loop" value="yes" />Useful when you want do skip software interfaces (dummy, loopback)</td>
</tr>
<tr>    
    <td colspan=2>
    <input type="submit" name="submit" id="submit" value="Create Class &gt;&gt;">
    </td>
</tr>
</table>
<br/>
</form>
<li><a href="service.php?do=edit&service_id={$service_id}">Return&nbsp;to&nbsp;rrdbot&nbsp;list</a></li>
</ul>
