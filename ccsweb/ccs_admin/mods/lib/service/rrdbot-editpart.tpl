...
<tr>    
    ...
    <td><input type="text" name="name" id="name" value="{$parts[0].name}"  />Name of variable in the rrd file</td>
</tr>
<tr>
    <th id="poll-header">Oid to collect</th>
    <td><input type="text" name="poll" id="poll" value="{$parts[0].poll}"  >The oid for the poller to collect</td>
</tr>
<tr>
    <th id="type-header">Type</th>
    <td>{html_options values=$type_ids output=$type_names selected=$parts[0].type name="type" id="type"}The variable type</td>
</tr>
<tr>
    <th id="min-header">Min</th>
    <td><input type="text" name="min" id="min" value="{$parts[0].min}"  >The minimal value for a GAUGE, leave blank for no minimal</td>
</tr>
<tr>
    <th id="max-header">Max</th>
    <td><input type="text" name="max" id="max" value="{$parts[0].max}"  >The maximum value for a GAUGE, leave blank for no maximum</td>
</tr>
<tr>    
    <td colspan=2>
    <input type="submit" name="submit" id="submit" value="Update Class Part &gt;&gt;">
    </td>
</tr>
</table>
<br/>
