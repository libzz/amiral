...
<div id="instructions">
Please enter the global details for ethernet customers below.</div>
<br />
<table class="details" id="ethernet_customer-details">
{include file="mods/service/ethernet_customer-propdetails.tpl" ethernet_customer=$ethernet_customer}
</table>
<br />
<ul>
