...
<br>
<a href="customer.php?do=edit&contact_id={$discount.customer_id}">Cancel</a>
&nbsp;|&nbsp;

<a href="discounts.php?do=deleteCustomerDiscount&confirm=yes&contact_id={$discount.customer_id}&customer_discount_id={$discount.customer_discount_id}">
Delete&nbsp;Discount&nbsp;&gt;&gt;</a>
<br><br>
